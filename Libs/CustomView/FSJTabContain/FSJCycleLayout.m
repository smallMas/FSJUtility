...
//        CGFloat trueDelta = attributes.center.x - ceterX;
//        if (trueDelta < 0) {//view在左边
//            attributes.center = CGPointMake(attributes.center.x + trueDelta, attributes.center.y);
//        } else {//view在右边
//            attributes.center = CGPointMake(attributes.center.x - trueDelta, attributes.center.y);
//        }
//        NSLog(@"计算后x:%f",attributes.center.x);
    }
